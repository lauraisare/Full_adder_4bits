...
-- Equation(s):
-- \A0|HA1|Sum~combout\ = \A[0]~input_o\ $ (\B[0]~input_o\)
...
-- Equation(s):
-- \A1|HA2|Sum~0_combout\ = \A[1]~input_o\ $ (\B[1]~input_o\ $ (((\A[0]~input_o\ & \B[0]~input_o\))))
...
-- Equation(s):
-- \A1|Cout~0_combout\ = (\A[1]~input_o\ & ((\B[1]~input_o\) # ((\A[0]~input_o\ & \B[0]~input_o\)))) # (!\A[1]~input_o\ & (\B[1]~input_o\ & (\A[0]~input_o\ & \B[0]~input_o\)))
...
-- Equation(s):
-- \A2|HA2|Sum~0_combout\ = \A1|Cout~0_combout\ $ (\B[2]~input_o\ $ (\A[2]~input_o\))
...
-- Equation(s):
-- \A2|Cout~0_combout\ = (\A1|Cout~0_combout\ & ((\B[2]~input_o\) # (\A[2]~input_o\))) # (!\A1|Cout~0_combout\ & (\B[2]~input_o\ & \A[2]~input_o\))
